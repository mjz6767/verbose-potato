...
- Combined RuleSmoke, focused combat-UI runtime smoke, SpriteArtRuntimeSmoke, full RuntimeBoot, the clean Windows build, source/staged/packaged art verification, canonical package inventory, and clean-extracted packaged boot pass with the live pins and mappings. The package contains 83 approved runtime art files. Nine built-player combat, power-book, and map captures pass deterministic validation and manual visual review under `QA/v2.9.0-release-visuals-741451a`; capture-set SHA-256 is `006b36b45b3e43672286bf4edc7d410f482ee1b16e8c26168b7ae375fae2c321`.
