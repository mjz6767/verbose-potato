...
Ash & Brimstone's first playable loop is a four-person tactical dungeon RPG slice: start at the Tavern, form a party, accept the Midgaard sewer contract, clear three authored sewer encounters, make one recovery-room gear choice, return proof, earn a visible equipment reward, then follow the opened Old Road from Sluice Steps through Dusk Market and the bounded kobold Chapter II rooms.
