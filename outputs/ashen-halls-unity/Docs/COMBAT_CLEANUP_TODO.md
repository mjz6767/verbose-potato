...
3. Done in v1.5.6 for turn finishing: player actions, enemy turns, and skipped stun/sleep turns now share one end-of-action policy. Future work can still centralize per-action validation/preview math.
