...
The integrated v2.15 candidate promotes six accepted runtime pins from the presentation slices below: the v2.12.1 title scroll and focus ribbon, v2.13 mage/warlock VFX, both v2.14 support/hex and class-skill VFX sheets, and the v2.15 combat-travel sheet. Together they bring `RuntimeArtManifest` to 54 exact pins and the expected packaged runtime-art inventory to 89 PNGs. Adjacent prompts and validation records preserve provenance but are not additional package-selected images.
