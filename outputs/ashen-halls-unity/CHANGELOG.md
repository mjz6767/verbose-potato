...
- Fixed the Beta packaging wrapper to wait for both Unity and the clean-extracted player before reading exit codes or removing temporary files, preventing false blank-exit failures on GUI-process hosts.
...
- Final zero-diagnostic compilation, InventoryLootExperienceSmoke, RuleSmoke, SpriteArtRuntimeSmoke, focused combat UI, full RuntimeBoot, clean retail packaging and clean-extracted boot pass from runtime source commit `11222c94b27d5541b9160e9a80ec7d55de60e407`. The guarded Beta archive/title smoke also passes. The retail ZIP SHA-256 is `80347335d998d42702583d6d33520d76af7136431bddb65d088625e5cdf384bb`; 20 accepted packaged-player captures have set SHA-256 `a66068e10c28a4157117d2de2678cf4965f9f606794e94aeac8bca942e3087c5`.
...
- Runtime/editor compilation, RuleSmoke, full RuntimeBoot, clean Windows build/package, clean-extracted boot, and built-player Fireball/Beta Lab review pass from source commit `8b1126127c162ef0d70b3ffddb1db60d971db006`. The 227,899,535-byte ZIP has SHA-256 `ab94b9ffde26da45c993d3c2074c24576faa40b66f1ed1d3145636e951001fb0`; the deterministic capture packet has SHA-256 `860a63f004e1be206c8475b1064ba16babca5230ff205c2dc869faba69f8ba8d`.
...
- Final combined RuleSmoke, full RuntimeBoot, runtime/editor compilation, exact art/audio checks, the clean-source canonical package, clean-extracted boot, and a four-capture title/combat/aftermath player review pass from source commit `44deb12bba873998f02081656b003b739f6ba535`. The 228,908,344-byte ZIP has SHA-256 `9dbdebf63650c7fcd3bb7cbba31d7aed05fcef9cda8c05a22b2560267f01b6be`; the capture set has SHA-256 `503a1dc05042c9db8e0a6344003b9252f81db6f05ecb97b4de328ac9544b9bbf`. Subjective listening, physical-controller review, live drag/wheel feel, and a complete human playthrough remain manual.
...
- Added deterministic rule and runtime coverage for bounded map browsing, input ownership, mutation-free chart inspection, legal combat cursor ordering/cycling, HUD-to-board focus transfer, confirmation, undo, pointer recovery, Reduced Motion, visual-smoke staging, and the new audio contracts. Deterministic audio checks, RuleSmoke, full RuntimeBoot, the clean Windows build/package, clean-extracted boot, and four-capture final-player visual review pass from source commit `387e84713cb10f0c86f3ce2787514cb70ddf4196`. The 226,917,110-byte ZIP has SHA-256 `b447870c32fe9d21d12e0c195b15fa52a497d30048309ced7dd05d14eaf71a65`; the capture set has SHA-256 `4e126d54fc881547514331a2e332a93460f53642ff09bcd8f9fcddbe38694a9d`. Subjective listening, physical-controller review, live drag/wheel feel, and a complete human playthrough remain manual.
...
- Added `Ashen Atlas`, the score's 54th reproducible master, as the dedicated World Map identity. Music transitions now use context-shaped equal-power fades, keep transport position while music is muted, and apply exploration dwell/release hysteresis so calm route changes do not chatter while pursuit still takes over immediately.
- Integrated the map and combat interface pass: the live exploration HUD owns one persistent command deck with clear map, Journal, Party, and Menu actions; the combat HUD keeps the current objective, acting/idle state, blocked-command reasons, target context, and pause-menu access legible without a second emergency strip competing for the same space.
- Simplified loot and equipment review. Reward-only spoils remain useful even without an item card, newly recovered gear identifies its best fit, Pack gains an Upgrades filter, and equipped gear can be reassigned as an explicit two-adventurer swap so the previous owner receives the replacement instead of silently losing a loadout. Successful equipment changes checkpoint immediately.
- Added accepted mage/warlock, support/hex, class-skill, and travel VFX sheets. Production travel now gives Fireball one canonical comet, stages deterministic single- and multi-strike motion before exact impact audio, covers all 56 formulas and all 25 skills with authored SFX profiles, and clears the travel layer under Reduced Motion.
- Preserved the v2.12 Red Gate campaign and save schema v25 while promoting six accepted runtime-art pins from the v2.12.1, v2.13, v2.14, and v2.15 presentation slices. The integrated manifest names 54 exact runtime pins and the package contains 89 approved PNGs.
- RuleSmoke, full RuntimeBoot, focused sprite-art and combat-UI checks, deterministic audio-bank validation, the clean Windows build/package, clean-extracted boot, and four-capture final-player visual review pass from source commit `43b9c9c985d59a273f39bdf14ea39f9d3f57e376`. The 226,844,217-byte ZIP has SHA-256 `d782e88eaee3e4684418f4d5923d2a94af50e68026169e15cae294dd007c46d1`; the capture set has SHA-256 `afe86e29f1b503b8001b68abd45a4a50ef87e0b4f34bab86e46b25c2facc7e15`. Subjective audio listening, physical-controller review, the live Reduced Motion comparison, and a complete human Chapter I-V playthrough remain manual.

## v2.12.0 - The Red Gate

- Promoted Chapter V from protected prototype scaffolding into an authored production campaign. After Yara copies the Emberglass key, the player can review a mutation-free crownward plan, explicitly accept it, retrace the exact Old Road -> Bone Road -> Glass Road route, and use the existing far Red Gate seal to enter the inner war road. Backing out of the review changes no story state, party progression, supplies, inventory, or map depth.
- Added three ordered Chapter V fights at three distinct authored sites: the Red Gate Vanguard at the inner seal, the Ossuary Road Seal guard at Gloam Deep Crypt, and the named Crownroad Marshal at Salt Cistern Gate. The later sites cannot be skipped. Three matching patrol bands—the Inner Gate Cinder Vanguard, Crownroad Ossuary Column, and Emberglass Drow Conclave—make depth five active without falling back to generic encounter markers.
- Made the vanguard tally and ossuary road seal durable route keys. Marshal victory grants exactly one `+6 crownward emberglass warblade` and two supplies; a deliberate follow-up inspection charts the Meteor Crown threshold and completes the chapter without entering unfinished Chapter VI. Retreat, recall, repaired objectives, repeated callbacks, save/load, and depth-five re-entry preserve progress without duplicating arrival XP, supplies, equipment, levels, or points.
- Extended the Golden Thread, compact objective, Journal, Yara dialogue, save repair, encounter catalog, roaming-threat catalog, and first-visit accounting through Chapter V. Completed companies receive a durable Yara debrief and may revisit depth five through the same authored seals, while production exposes no generic depth-six stair or final-boss trigger. Save schema remains v25 and the approved runtime-art set is unchanged.
- Optimized world-map presentation without adding another art dependency. The sidebar now truthfully identifies itself as the World Map, draws the live Golden Thread and destination above a cached point-filtered terrain raster, and keeps dynamic sites, patrols, viewport, and party markers on top. Static geography rebuilds only after movement, map replacement, depth change, or an authoritative terrain edit; non-repaint interface events no longer redraw the full board or minimap.
- Reused the approved progression atlas to make Chapter V state readable at a glance: the Red Gate shows its authored seal before the vanguard falls, the crypt and cistern remain visibly locked until their route steps open, cleared sites receive the wreath, and marshal victory reveals the Meteor Crown omen until the threshold survey is complete. Atlas validation and first-use trim metrics now share one pixel snapshot instead of repeatedly allocating a full atlas-sized array per cell.
- Added deterministic rule and full live-campaign coverage for the briefing gate, exact four-map return route, three story fights, three patrols, ordering locks, unique reward, explicit threshold survey, debrief, idempotence, re-entry, and Chapter VI boundary. Unity's generated runtime and editor response files compile the integrated source successfully. RuleSmoke, RuntimeBoot, focused roaming-threat smoke, Windows build/package, packaged boot, visual review, controller review, and a complete human Chapter I-V playthrough remain candidate gates because the local Unity license service rejected batch execution before tests could start.
...
- Added deterministic rule and runtime coverage for collision/opacity contracts, Old Road continuity, exact story routing, all three Chapter III encounters, retreat and retry, unique rewards, chapter completion, marker repair, recall and re-entry, Journal state, and the survey-only frontier boundary. Integrated RuleSmoke, focused combat-UI runtime smoke, full RuntimeBoot, SpriteArtRuntimeSmoke, the clean Windows build, canonical package integrity, clean-extracted packaged boot, and a five-capture built-player world-map matrix pass from source commit `67e1e67ae87eef7be67eb8e82cc46cdb17f778af`. The package SHA-256 is `e3f9ee8847c9310128177bb9738728fc0da54e66ed094d010f867730ba05a4c9`; the visual capture-set SHA-256 is `d91c17b1ace30cc11204f43ba35c95536f14774aecfe2445f4bf27a4bf310544`. Runtime art and provenance pins remain unchanged at 83 packaged files, and save schema stays v25.
...
- Combined RuleSmoke, full RuntimeBoot, focused combat-UI runtime smoke, SpriteArtRuntimeSmoke, the clean Windows build, canonical package integrity gate, and clean-extracted packaged boot pass. A nine-capture built-player matrix covering combat, spell impact, Spellbook and Ranger Skillbook states, Local Map, and two Region Map routes passes deterministic validation and manual visual review under `QA/v2.9.0-release-visuals-741451a`; its capture-set SHA-256 is `006b36b45b3e43672286bf4edc7d410f482ee1b16e8c26168b7ae375fae2c321`. The package contains 83 approved runtime art files. Physical-controller review and a complete human playthrough remain pending release checks.
...
- Preserved the 10 by 9 Town Hall room, 8 by 7 floor, six patrons, stable object IDs, first spawn, company runner, storm-door exit, portal/objective flow, collision, interaction, gameplay, and save schema v25. Built-in ImageGen, local chroma removal, and project atlas normalization are recorded in the v2.8 handoff. RuleSmoke, focused SpriteArtRuntimeSmoke, full RuntimeBoot, the Windows build, six supported-resolution Local/Region captures, the deterministic visual packet, canonical packaging, and clean-extracted packaged boot pass. The release-integrity record reports clean tracked source, save v25, exit code 0, and 83 packaged art files.
...
- Preserved the stable 10 by 9 Town Hall room, 8 by 7 open floor, spawn/exit, oxblood-and-charcoal tutorial runner, fixture and patron positions, portal/objective/autosave flow, gameplay, and save schema v25. RuleSmoke, focused SpriteArtRuntimeSmoke, full RuntimeBoot, the final Windows build, and six accepted built-player captures pass. Canonical package inventory and clean-extracted packaged boot also pass from a clean tracked source. `QA/v2.7.0-release-integrity/release-integrity-manifest.json` is authoritative for the source state, batch exploration boot, player exit, 82 packaged art files, and both exact Grand Hearth atlas hashes. Physical-controller review and a complete human playthrough remain manual gates.
...
- Made departure from Town Hall the required first journey step. NEXT, objective copy, door copy, arrival/departure feedback, and the first checkpoint now agree that the journey begins only after the company leaves through the storm doors; the route then advances to King Halvard. RuleSmoke, focused sprite-art runtime smoke, full RuntimeBoot, the Windows build, and four direct built-player Local/Region captures at 1280 by 720 and 1920 by 1080 pass. Canonical packaging and clean-extracted packaged boot also pass; the release-integrity record reports `sourceDirty=false`, `cleanExtractLaunch=true`, `playerExitCode=0`, and 80 packaged art PNGs while binding the exact final source revision and hashes. Physical-controller review and a complete human playthrough remain manual gates. Existing campaign data remains compatible; save schema remains v25.
...
- Added deterministic rule and live runtime coverage for layout, navigation focus, mutation-free preview/reset, atomic application, stale-draft cleanup, combat lockout, and save/load continuity. RuleSmoke, focused sprite-art and combat-UI runtime smoke, full RuntimeBoot, Windows build/package, clean-extracted packaged boot, and direct 960 by 600, 1280 by 720, and 1920 by 1080 Growth captures pass from the settled release source. Physical-controller review and a complete human playthrough remain manual gates. Existing campaign data remains compatible; save schema remains v25.
...
- Added three exact transparent 4 by 2 world-map atlases. Active faction habitats remain at each roaming threat's saved home beneath its moving token, while defeated patrol homes settle into neutral ruined-waystation aftermath art. Deterministic non-interactive citizens add district-appropriate exterior and non-safe-road ambience while staying off the Grand Hearth tutorial lane, current guidance, certified safe roads, rooms, hazards, entrances, authored sites, and interactables. Single-member parties receive role-specific exploration silhouettes while multi-member parties retain the established group marker. Named NPC and dialogue identities, combat and inventory art, encounters, safe roads, and saves are unchanged.
...
- Automated v2.4.0 verification passes from the settled release source: RuleSmoke, focused sprite-art and combat-UI runtime smoke, full RuntimeBoot, the Windows build/package, and clean-extracted packaged boot. The final combined 720p/1080 visual matrix, physical-controller review, subjective audio/effect review, and a complete human playthrough remain manual checks. Existing campaign data remains compatible; save schema remains v25.
...
- Added exact command-atlas dimension, mapping, coverage, gutter, loading, responsive-layout, focusability, blocked-state, focus-cleanup, and armed-art checks. RuleSmoke, focused combat-UI runtime smoke, full RuntimeBoot, the Windows build/package, and clean-extracted packaged boot pass in Unity 6000.3.18f1. Six development-player captures at 1280x720 and 1920x1080 also exit cleanly and visually confirm blocked and legal Attack, armed Fireball, Spellbook targeting, Skillbook selection, keycap clearance, and responsive command spacing. Save schema remains v25.
