namespace AshenHalls
{
    ...
    {
        public const string AbilityIconAtlas = "ability-icon-atlas-runtime-v1.31.0.png";
        public const string SignatureSpellIconAtlas = "signature-spell-icon-atlas-runtime-v1.31.0.png";
        public const string LightningSpellIconAtlas = "lightning-spell-icon-atlas-runtime-v1.79.0.png";
        ...
        public const string TavernBackdrop = "tavern-backdrop-runtime-v1.49.0.png";
        public const string MidgaardGateAtlas = "midgaard-gate-atlas-runtime-v1.64.0.png";
        public const string MidgaardWallAtlas = "midgaard-wall-atlas-runtime-v1.30.0.png";
        public const string WorldMapExplorationTileAtlas = "world-map-exploration-tile-atlas-runtime-v1.68.0.png";
        public const string WorldMapMaterialAtlas = "world-map-material-atlas-runtime-v1.68.0.png";
        public const string WorldMapOverlayAtlas = "world-map-overlay-atlas-runtime-v0.80.png";
        public const string WorldMapProgressionOverlayAtlas = "world-map-progression-overlay-atlas-runtime-v0.63.png";
        public const string WorldMapUiAtlas = "world-map-ui-atlas-runtime-v1.6.0.png";
        public const string WorldMapTokenSpriteAtlas = "world-map-token-sprite-atlas-runtime-v1.29.0.png";
        public const string WorldMapPropAtlas = "world-map-prop-atlas-runtime-v1.29.0.png";
        public const string WorldMapBiomePropAtlas = "world-map-biome-prop-atlas-runtime-v1.29.0.png";
        ...
        public const string MidgaardNpcAtlas = "midgaard-npc-atlas-runtime-v1.81.0.png";
        ...
        public const string CharacterCombatAtlas = "character-combat-atlas-runtime-v1.77.0.png";
        ...
        public static readonly string[] ApprovedRuntimeFiles =
        {
            AbilityIconAtlas,
            ...
            WorldMapOverlayAtlas,
            WorldMapProgressionOverlayAtlas,
            WorldMapUiAtlas,
            WorldMapTokenSpriteAtlas,
            WorldMapPropAtlas,
            WorldMapBiomePropAtlas,
